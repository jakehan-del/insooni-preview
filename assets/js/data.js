  ...
  recaps: [
    {
      ...
      photos: [
        { img: "assets/img/photos/hanteo-1.webp", w: 1200, h: 1600, caption: "트로피와 꽃다발" },
        { img: "assets/img/photos/hanteo-2.webp", w: 1200, h: 1600, caption: "트로피를 들어 올리며" },
        { img: "assets/img/photos/hanteo-3.webp", w: 1600, h: 1227, caption: "무대 인사" },
        { img: "assets/img/photos/hanteo-4.webp", w: 900, h: 1600, caption: "스크린 속 초록 드레스" },
        { img: "assets/img/photos/hanteo-5.webp", w: 1600, h: 1200, caption: "한터뮤직어워즈 무대" }
      ]
    },
    {
      ...
      photos: [
        { img: "assets/img/photos/openc-1.webp", w: 1200, h: 1600, caption: "무대 리허설" },
        { img: "assets/img/photos/openc-2.webp", w: 1200, h: 1600, caption: "베이시스트와 함께" },
        { img: "assets/img/photos/openc-3.webp", w: 1200, h: 1600, caption: "대기실의 웃음" },
        { img: "assets/img/photos/openc-4.webp", w: 1200, h: 1600, caption: "출연 대기" },
        { img: "assets/img/photos/openc-5.webp", w: 1232, h: 1600, caption: "노란 꽃, 검은 드레스" },
        { img: "assets/img/photos/openc-6.webp", w: 1268, h: 1600, caption: "백스테이지 포트레이트" }
      ]
    },
    {
      ...
      photos: [
        { img: "assets/img/photos/dsprac-1.webp", w: 1600, h: 900, caption: "안무 연습실에서" },
        { img: "assets/img/photos/dsprac-2.webp", w: 900, h: 1600, caption: "거울 앞의 시간" }
      ]
    },
    {
      date: "", year: "",
      ...
      photos: [
        { img: "assets/img/photos/jazzc-1.webp", w: 1600, h: 900, caption: "스포트라이트 아래, 재즈 밴드와" },
        { img: "assets/img/photos/jazzc-2.webp", w: 1200, h: 1600, caption: "객석에서 본 무대" },
        { img: "assets/img/photos/jazzc-3.webp", w: 900, h: 1600, caption: "소극장의 밤" }
      ]
    },

    {
      ...
      photos: [
        { img: "assets/img/photos/woi-award.webp", w: 1074, h: 1542, caption: "'올해의 여성상' 시상 순간" },
        { img: "assets/img/photos/woi-flag.webp", w: 900, h: 1600, caption: "기념 성조기 전달" },
        { img: "assets/img/photos/woi-speech.webp", w: 900, h: 1600, caption: "수상 연설, 연단에서" },
        { img: "assets/img/photos/woi-podium.webp", w: 900, h: 1600, caption: "Woman of Influence 2025 로고 앞에서" },
        { img: "assets/img/photos/woi-song.webp", w: 900, h: 1600, caption: "객석 사이에서 부른 축하 무대" },
        { img: "assets/img/photos/woi-audience.webp", w: 900, h: 1600, caption: "객석에서, 박수와 함께" }
      ]
    },
    {
      year: "2025",
    ...
    },
    {
      ...
      photos: [
        { img: "assets/img/photos/dsc0427.webp", w: 1600, h: 1065, caption: "깃털 장식 흰 의상, 오케스트라와 함께" },
        { img: "assets/img/photos/dsc0628.webp", w: 1600, h: 1063, caption: "댄서들과 함께한 스팽글 무대" },
        { img: "assets/img/photos/dsc0284.webp", w: 1600, h: 1063, caption: "순백의 무대 세트" },
        { img: "assets/img/photos/dsc0369.webp", w: 1600, h: 1063, caption: "흰 의상의 군무와 함께" },
        { img: "assets/img/photos/dsc0081.webp", w: 1063, h: 1600, caption: "쏟아지는 조명 아래, 스팽글 드레스" },
        { img: "assets/img/photos/dsc9427.webp", w: 1600, h: 1063, caption: "원색의 무대, 폭발하는 에너지" }
      ]
    },
    {
      year: "",
      ...
      photos: [
        { img: "assets/img/photos/kakao21.webp", w: 1600, h: 1067, caption: "네온 조명의 대형 무대" },
        { img: "assets/img/photos/kakao22.webp", w: 1600, h: 1067, caption: "도시의 불빛을 닮은 무대 세트" }
      ]
    }
  ],
