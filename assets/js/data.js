...
window.SITE_DATA = {
  ...
  albums: [
    ...
    { featured: true, art: "assets/img/photos/album04.jpg", year: "1983", title: "밤이면 밤마다 — 독집 제4집", kind: "정규 4집", note: "디바의 시대를 연 폭발적 히트곡 '밤이면 밤마다' 수록. 1983년 5월 발매.",
    ...
    { featured: true, art: "assets/img/covers/cover2025.jpg", year: "2025", title: "인순이, 아름다운 우리나라", kind: "정규 앨범", note: "2025년 2월 발매, 9곡 수록. 커버는 1984년 5집 원반 아트를 그대로 살렸습니다.",
  ...
  /* ---------- 신청곡 시드 (운영 예시 수치) ---------- */
  requestSeed: [
    { t: "거위의 꿈", n: 128 }, { t: "밤이면 밤마다", n: 97 }, { t: "친구여", n: 64 },
    { t: "아버지", n: 52 }, { t: "또", n: 41 }, { t: "실버들", n: 33 },
    { t: "그래도 꿈은 흐른다", n: 29 }, { t: "행복", n: 24 }, { t: "나무", n: 18 }
  ]
};
