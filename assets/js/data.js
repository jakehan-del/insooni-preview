...
window.SITE_DATA = {
  ...
  pastShows: [
    { date: "2025-07-09", city: "서울", venue: "국립극장 하늘극장", title: "여우락 페스티벌 '두 사랑 이야기'", en: { title: "Yeowoorak Festival 'Two Love Stories'", city: "Seoul", en: { title: "Yeowoorak Festival 'Two Love Stories'", excerpt: "Two nights with Yoo Ji-sook at the National Theater of Korea." } } },
    { date: "2024-05-18", city: "인천", venue: "송도컨벤시아", title: "골든걸스 콘서트", en: { title: "Golden Girls Concert", city: "Incheon" } },
    { date: "2024-04-20", city: "부산", venue: "KBS부산홀", title: "골든걸스 전국투어", en: { title: "Golden Girls National Tour", city: "Busan" } },
    { date: "2024-03-02", city: "성남", venue: "성남아트센터", title: "골든걸스 콘서트", en: { title: "Golden Girls Concert", city: "Seongnam" } },
    { date: "2023-12-14", city: "안성", venue: "안성맞춤아트홀", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Anseong" } },
    { date: "2023-02-18", city: "캘리포니아", venue: "페창가 리조트", title: "인순이 단독 라이브", en: { title: "Insooni Live", city: "California" } },
    { date: "2022-12-30", city: "전주", venue: "삼성문화회관", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Jeonju" } },
    { date: "2019-12-21", city: "서울", venue: "파르나스 그랜드볼룸", title: "연말 디너쇼", en: { title: "Year-End Dinner Show", city: "Seoul" } },
    { date: "2019-01-12", city: "부산", venue: "부산문화회관", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Busan" } },
    { date: "2018-12-23", city: "서울", venue: "롯데호텔 크리스탈볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2018-03-31", city: "서울", venue: "올림픽홀", title: "데뷔 40주년 해 단독 공연", en: { title: "Solo Concert, 40th Anniversary Year", city: "Seoul" } },
    { date: "2017-12-29", city: "김해", venue: "김해문화의전당", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Gimhae" } },
    { date: "2017-12-22", city: "서울", venue: "롯데호텔 크리스탈볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2017-09-16", city: "부산", venue: "벡스코 오디토리움", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Busan" } },
    { date: "2016-12-21", city: "서울", venue: "그랜드하얏트 그랜드볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2016-02-16", city: "서울", venue: "세종문화회관 대극장", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Seoul" } },
    { date: "2015-12-22", city: "서울", venue: "그랜드하얏트 그랜드볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2015-01-24", city: "수원", venue: "경기아트센터", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Suwon" } },
    { date: "2014-12-24", city: "서울", venue: "그랜드하얏트 그랜드볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2013-12-28", city: "서울", venue: "그랜드하얏트 그랜드볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2013-07-06", city: "서울", venue: "국립극장 해오름극장", title: "뮤지컬 '시카고' 벨마 켈리", en: { title: "Musical CHICAGO, Velma Kelly", city: "Seoul" } },
    { date: "2012-12-23", city: "서울", venue: "63빌딩 컨벤션센터", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    { date: "2012-06-09", city: "서울", venue: "디큐브아트센터", title: "뮤지컬 '시카고' 벨마 켈리", en: { title: "Musical CHICAGO, Velma Kelly", city: "Seoul" } },
    { date: "2012-05-19", city: "성남", venue: "성남아트센터", title: "콘서트 '판타지아'", en: { title: "Concert 'Fantasia'", city: "Seongnam" } },
    { date: "2012-05-09", city: "부산", venue: "롯데호텔 크리스탈볼룸", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Busan" } },
    { date: "2011-12-22", city: "서울", venue: "센트럴시티 밀레니엄홀", title: "인순이 디너쇼", en: { title: "Insooni Dinner Show", city: "Seoul" } },
    ...
    { date: "2010-11-20", city: "청주", venue: "청주 실내체육관", title: "콘서트 '판타지아'", en: { title: "Concert 'Fantasia'", city: "Cheongju" } },
    { date: "2010-02-01", city: "뉴욕", venue: "카네기홀 아이작 스턴 홀", title: "두 번째 카네기홀 콘서트", en: { title: "Second Carnegie Hall Concert", city: "New York" } },
    { date: "2009-12-30", city: "서울", venue: "63빌딩 컨벤션센터", title: "아듀 2009 송년 디너쇼", en: { title: "Adieu 2009 Dinner Show", city: "Seoul" } },
    { date: "2009-12-27", city: "서울", venue: "올림픽홀", title: "콘서트 'LEGEND & FOREVER'", en: { title: "'LEGEND & FOREVER' Concert", city: "Seoul" } },
    { date: "2009-10-24", city: "안산", venue: "안산문화예술의전당", title: "데뷔 30주년 'Legend'", en: { title: "30th Anniversary 'Legend'", city: "Ansan" } },
    { date: "2008-12-19", city: "서울", venue: "그랜드하얏트 그랜드볼룸", title: "송년 디너쇼 '뜨거운 만남'", en: { title: "Year-End Dinner Show 'Hot Encounter'", city: "Seoul" } },
    { date: "2008-04-03", city: "서울", venue: "세종문화회관 대극장", title: "데뷔 30주년 전국투어", en: { title: "30th Anniversary National Tour", city: "Seoul" } },
    { date: "2007-12-22", city: "서울", venue: "스위스 그랜드 호텔", title: "인순이 콘서트", en: { title: "Insooni Concert", city: "Seoul" } },
    { date: "2007-06-02", city: "부산", venue: "부산 KBS홀", title: "콘서트 '드리머'", en: { title: "Concert 'Dreamer'", city: "Busan" } },
    { date: "2006-12-22", city: "서울", venue: "63빌딩 국제회의장", title: "송년 디너쇼", en: { title: "Year-End Dinner Show", city: "Seoul" } },
    { date: "2005-12-22", city: "서울", venue: "롯데호텔 크리스탈볼룸", title: "송년 디너쇼", en: { title: "Year-End Dinner Show", city: "Seoul" } },
    { date: "2004-12-22", city: "서울", venue: "롯데호텔 크리스탈볼룸", title: "송년 디너쇼", en: { title: "Year-End Dinner Show", city: "Seoul" } },
