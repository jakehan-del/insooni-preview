...
if (grid.dataset.stageBg) return;
...
var safety = setTimeout(reveal, 12000);
try {
...
leaf.style.zIndex = String(20 - li);
...
var STEP = 0.8, PEEL = 0.4, M_END = 0, T_END = 0;
