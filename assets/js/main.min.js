...
var GOOSE_POSES = ["assets/img/goose-rest.webp",
"assets/img/goose-down.webp",
"assets/img/goose-up.webp"];
var G_BASE = 512;
var G_CROUCH = 2.30;
var G_RISE = 2.52;
var G_CROSS = 3.25;
...
var u = gOut(g01((t - G_GLIDE) / (G_END - G_GLIDE)));
...
var p = goosePath(Math.max(0, tc - i * 0.085), st);
...
var over = (ly - (gpN.y - gpN.s / 2)) / (st.S * 0.085);
